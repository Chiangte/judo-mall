package com.github.judo.common.constant;
...
public interface SecurityConstants {
     ...
     * 项目的license
     */
    String JUDO_LICENSE = "made by judo";
    /**
     * 基础角色
     */
     ...
     * 手机号的处理验证码的url前缀
     */
    String REGISTER_VALIDATE_CODE_URL_PREFIX = "/registerCode";
     ...
     * 注册保存code的前缀
     */
    String REGISTER_CODE_KEY = "REGISTER_CODE_KEY";
    /**
     * 验证码文字大小
     */
