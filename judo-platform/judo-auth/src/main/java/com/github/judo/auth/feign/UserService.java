package com.github.judo.auth.feign;

import com.github.judo.auth.feign.fallback.UserServiceFallbackImpl;
 ...
 * @Version: 1.0
 */
@FeignClient(name = "judo-admin-service", fallback = UserServiceFallbackImpl.class)
