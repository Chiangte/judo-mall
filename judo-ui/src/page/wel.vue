<template>
  <div class="pull-chheight wel-contailer">
    <div class="banner-text">
      <h2>Judo Microservice Architecture</h2>
      <span align="center">
      ...
      <span>
          <el-collapse v-model="activeNames">
            <el-collapse-item title="项目地址" name="1">
              <a href="https://gitee.com/gibbons/judo-platform" target="_blank">
